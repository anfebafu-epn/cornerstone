...
function ServiceCall(Call : cornerstone_integrator_transport_MethodCall, callback) {
...
function ServiceMultiCall(Calls: Array<cornerstone_integrator_transport_MethodCall>, callback) {
    var req = new cornerstone_integrator_transport_RequestMessage();
    req.set_RequestSeq(100);
    req.set_SessionID("");
    req.set_Calls(Calls);
