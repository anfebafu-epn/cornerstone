...
function Proxy_benchmark_Benchmark_Test1(callback) {
    return ServiceCall(Call_benchmark_Benchmark_Test1('N'), callback);
}
function Call_benchmark_Benchmark_Test2(Par, name) {
    var mcc = new cornerstone_integrator_transport_MethodCall();
    mcc.set_LogicModule("benchmark");
    mcc.set_LogicClass("cornerstone.benchmark.Benchmark");
...
function Proxy_benchmark_Benchmark_Test2(Par, callback) {
...
function Proxy_benchmark_Benchmark_Test3(callback) {
...
function Proxy_benchmark_Benchmark_Benchmark1(callback) {
...
function Proxy_benchmark_Benchmark_Benchmark2(callback) {
...
function Proxy_benchmark_Benchmark_Benchmark3(callback) {
