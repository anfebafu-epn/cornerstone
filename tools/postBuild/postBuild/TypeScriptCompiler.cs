...
namespace postBuild
{
    public static class TypeScriptCompiler
    {
        ...
        public static void Compile(string tsPath, Options options = null)
        {
            ...
            string TscPath = ConfigurationManager.AppSettings["TscPath"];

            //// https://www.microsoft.com/en-us/download/confirmation.aspx?id=48593
            ProcessStartInfo psi = new ProcessStartInfo(TscPath, tsPath + " " + String.Join(" ", d.Select(o => o.Key + " " + o.Value)));
    ...
    {
        public InvalidTypeScriptFileException()
            : base()
        {
